                                         ...
                                         unsigned int msg_len)
{
    ...
    if (new_pw != NULL) {
        ...
        code = (int) kadm5_init_krb5_context(&context);
    ...
    if (code == KADM5_OK) {
        ...
        msg_ret[msg_len - 1] = '\0';
        return(0);
    } else if ((code != KADM5_PASS_Q_TOOSHORT) &&
    ...
    if (code2 != 0) {
        ...
        msg_ret[msg_len - 1] = '\0';
        return(code);
    } else if ((princ_ent.aux_attributes & KADM5_POLICY) == 0) {
