   ...
   register SVCXPRT *transp;
{
     union {
	  ...
	  setkey4_arg setkey_principal4_arg;
	  getpkeys_arg get_principal_keys_arg;
     } argument;
     union {
	  generic_ret gen_ret;
