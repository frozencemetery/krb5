...
#define PLUGIN_INTERFACE_HOTFIND     13
#define PLUGIN_NUM_INTERFACES        14
...
struct _krb5_context {
    ...
    /* hotfind module stuff */
    struct hotfind_module_handle **hotfind_handles;
